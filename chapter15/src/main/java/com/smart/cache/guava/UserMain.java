...
public class UserMain {
    public static void main(String... args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("applicationContext-guava.xml");
        UserService userService = (UserService) context.getBean("guavaUserServcie");
